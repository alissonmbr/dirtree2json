...
function folderToJson(path_, options_) {
    ...
    // General configs
    options.rootPath = options.rootPath !== null && options.rootPath !== undefined ? options.rootPath : PATH.basename(path_);
    options.rootName = options.rootName !== null && options.rootName !== undefined ? options.rootName : PATH.basename(path_);
